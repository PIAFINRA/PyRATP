...
# This file has been generated at Tue Apr 19 11:56:35 2011
...
__all__ = ['test1', '_66780144', 'micrometeo', '_66780208', 'vegetation', 'complet']
...
_66780144 = CompositeNodeFactory(name='vegestar grid',
                             description='',
                             category='Unclassified',
                             doc='',
                             inputs=[],
...
_66780208 = CompositeNodeFactory(name='test_grid',
                             description='',
                             category='Unclassified',
                             doc='',
                             inputs=[],
...
complet = CompositeNodeFactory(name='complet',
   ...
   14: ('PyRATP', 'do_all')},
                             elt_connections={  10018400: (5, 4, 6, 4),
   10018412: (9, 0, 14, 0),
   10018424: (8, 0, 4, 0),
   10018436: (13, 0, 12, 0),
   10018448: (4, 0, 6, 6),
   ...
   10018580: (5, 5, 6, 5)},
         ...
         'caption': 'read_micrometeo',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x0400A450> : "read_micrometeo"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   3: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x0463F350> : "mmeteo082050.mto"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set([2]),
   ...
   4: {  'block': False,
         'caption': 'read grid',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x0400A2F0> : "read grid"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   5: {  'block': False,
         'caption': 'plant from vegestar',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x0400A3F0> : "plant from vegestar"',
         'hide': True,
         'id': 5,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         'caption': 'fill grid',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x0400A330> : "fill grid"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -269.22408630961593,
         'posy': -46.827547157007714,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   7: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x0463F430> : "digitalAA2004.vgx"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set([2]),
         'posx': -376.442491927437,
         'posy': -288.38395338527005,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   8: {  'block': False,
         'caption': 'grid3Da_2004.grd',
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x0463F450> : "grid3Da_2004.grd"',
         'hide': True,
         'id': 8,
         'lazy': True,
         'port_hide_changed': set([2]),
         'posx': -175.7731024519295,
         'posy': -280.21189680029482,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   9: {  'block': False,
         'caption': 'read_vegetation',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x0400A410> : "read_vegetation"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          'caption': 'vegetationa_2004.vfn',
          'delay': 0,
          'factory': '<openalea.core.data.DataFactory object at 0x0463F470> : "vegetationa_2004.vfn"',
          'hide': True,
          'id': 10,
          'lazy': True,
          'port_hide_changed': set([2]),
   ...
   12: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x0400A290> : "read_skyvault"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.data.DataFactory object at 0x0463F3D0> : "skyvaultsoc.skv"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set([2]),
   ...
   14: {  'block': False,
          'caption': 'do_all',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x0400A350> : "do_all"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   6: {'position': [-269.22408630961593, -46.827547157007714], 'userColor': None, 'useUserColor': False},
   7: {'position': [-376.442491927437, -288.38395338527005], 'userColor': None, 'useUserColor': False},
   8: {'position': [-175.7731024519295, -280.21189680029482], 'userColor': None, 'useUserColor': False},
