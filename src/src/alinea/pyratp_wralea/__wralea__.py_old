...
# This file has been generated at Tue Dec 06 08:45:04 2011
...
__all__ = ['ExtractLight_ExtractLight', 'ratp_read_micrometeo', 'ratp_read_grid', 'ratp_DoAll', 'ratp_fill_grid', 'ratp_DoIrradiation', 'ratp_read_vgx', 'ratp_ExtractTime', 'ratp_extract_leaves', 'ratp_read_vegetation', 'ratp_can2riri', 'ratp_read_skyvault']
...
ExtractLight_ExtractLight = Factory(name='ExtractLight',
                ...
                inputs=[{'interface': None, 'name': 'Elt2Voxel', 'value': None, 'desc': ''}, {'interface': None, 'name': 'RATPOutput', 'value': None, 'desc': ''}, {'interface': IInt, 'name': 'Day', 'value': None, 'desc': ''}, {'interface': IInt, 'name': 'Hour', 'value': None, 'desc': ''}],
